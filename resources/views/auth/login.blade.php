...
<body class="bg-gray-50 font-sans min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col p-8 md:p-10">
        ...
        @if($errors->has('email'))
        <div class="mb-4 bg-rose-50 text-rose-700 px-4 py-3 rounded-xl border border-rose-100 text-sm font-medium">
            {{ $errors->first('email') }}
        </div>
        @endif
