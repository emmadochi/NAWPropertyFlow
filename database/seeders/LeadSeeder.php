...
class LeadSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $lead1 = Lead::create([
            ...
            'budget_range' => '₦100M+',
            'property_interest_id' => $properties->where('property_type', 'Duplex')->first()?->id ?? $properties->first()->id,
        ...
        $lead2 = Lead::create([
            ...
            'property_interest_id' => $properties->where('property_type', 'Terrace')->first()?->id ?? $properties->first()->id,
        ...
        $lead3 = Lead::create([
            ...
            'property_interest_id' => $properties->where('property_type', 'Land')->first()?->id ?? $properties->random()->id,
        ...
        $lead4 = Lead::create([
            ...
            'budget_range' => '₦60M - ₦100M',
            'property_interest_id' => $properties->where('property_type', 'Flat')->first()?->id ?? $properties->random()->id,
        ...
        $lead5 = Lead::create([
            ...
            'budget_range' => '₦100M+',
            'property_interest_id' => $properties->where('property_type', 'Duplex')->last()?->id ?? $properties->last()->id, // Banana Island Duplex
