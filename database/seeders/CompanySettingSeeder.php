...
class CompanySettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if ($existing && !empty($existing->company_name) && $existing->company_name !== 'NAW Properties Ltd') {
            // Preserve the tenant's custom company identity (e.g., Ricaf Nigeria Limited)
            $existing->update([
